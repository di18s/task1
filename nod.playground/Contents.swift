...
func nok(a: [Int]) -> Int{
    ...
    // когда прошлись полностью по массиву надо пройтись еще раз чтобы проверить что нашли наименьшее общее кратное, как сделать проверку сколько раз проходить не придумал сделал 6 раза =)
    while t != 5 {
